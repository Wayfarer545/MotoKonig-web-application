# app/infrastructure/specs/listing/listing_by_seller.py
...
class ListingBySeller(ListingSpecificationPort):
    """Спецификация для поиска объявлений по продавцу"""

    def __init__(self, seller_id: UUID, active_only: bool = True):
        self.seller_id = seller_id
        self.active_only = active_only

    def to_query(self, base_query: Any) -> Any:
        query = base_query.where(ListingModel.seller_id == self.seller_id)
